...
- Phase A-1 SKIPPED(2026-04-19 calibration),Phase B 为 Phase 5 实施第一步
...
### 2. ~~Phase A-1 EC2 备份~~ SKIPPED(Ian calibration 2026-04-19)

- 原假设 EC2 有价值数据需备份,实际为测试数据无价值
- 详见 phase-a-backup.md 顶部 skip 区块
- Phase B 可直接启动,无前置
