...
const store1MenuItems = [
  {
    ...
    price: 3800, available: true, sortOrder: 1,
    options: [
      {
  ...
  },
  {
    ...
    price: 4500, available: true, sortOrder: 3,
    options: [
      {
        id: uuid(), name: '配菜', nameEn: 'Side', required: false,
        choices: [
          { id: uuid(), name: '加蛋', nameEn: 'Add Egg', priceAdjust: 300 },
          { id: uuid(), name: '加豆腐', nameEn: 'Add Tofu', priceAdjust: 200 },
        ],
      },
    ],
  },
  { id: uuid(), storeId: store1Id, categoryId: store1Categories[1].id, name: '拍黄瓜', nameEn: 'Smashed Cucumber', description: '清爽开胃', descriptionEn: 'Refreshing appetizer', price: 1200, available: true, sortOrder: 1 },
  { id: uuid(), storeId: store1Id, categoryId: store1Categories[1].id, name: '凉拌木耳', nameEn: 'Wood Ear Mushroom Salad', description: '营养健康', descriptionEn: 'Healthy and nutritious', price: 1500, available: true, sortOrder: 2 },
  {
    id: uuid(), storeId: store1Id, categoryId: store1Categories[2].id,
    name: '柠檬水', nameEn: 'Lemonade', price: 800, available: true, sortOrder: 1,
    options: [
      {
  ...
  { id: uuid(), storeId: store1Id, categoryId: store1Categories[2].id, name: '可乐', nameEn: 'Cola', price: 600, available: true, sortOrder: 2 },
  { id: uuid(), storeId: store1Id, categoryId: store1Categories[2].id, name: '酸梅汤', nameEn: 'Plum Juice', price: 1000, available: true, sortOrder: 3 },
  {
    id: uuid(), storeId: store1Id, categoryId: store1Categories[3].id,
    name: '米饭', nameEn: 'Rice', price: 300, available: true, sortOrder: 1,
    options: [
      {
        id: uuid(), name: '份量', nameEn: 'Size', required: true,
        choices: [
          { id: uuid(), name: '小碗', nameEn: 'Small', priceAdjust: 0 },
          { id: uuid(), name: '大碗', nameEn: 'Large', priceAdjust: 100 },
        ],
      },
    ],
  },
  { id: uuid(), storeId: store1Id, categoryId: store1Categories[3].id, name: '炒面', nameEn: 'Fried Noodles', description: '酱香炒面', descriptionEn: 'Stir-fried noodles with sauce', price: 1800, available: true, sortOrder: 2 },
]
...
const store2MenuItems = [
  {
    ...
    price: 5800, available: true, sortOrder: 1,
    options: [
      {
        id: uuid(), name: '辣度', nameEn: 'Spice Level', required: true,
        choices: [
  ...
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[0].id, name: '番茄锅底', nameEn: 'Tomato Soup Base', description: '酸甜可口', descriptionEn: 'Sweet and sour', price: 4800, available: true, sortOrder: 2 },
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[0].id, name: '鸳鸯锅底', nameEn: 'Half & Half Soup Base', description: '一锅两味', descriptionEn: 'Two flavors in one pot', price: 6800, available: true, sortOrder: 3 },
  {
    ...
    price: 4200, available: true, sortOrder: 1,
    options: [
      {
        id: uuid(), name: '份量', nameEn: 'Size', required: true,
        choices: [
          { id: uuid(), name: '半份', nameEn: 'Half', priceAdjust: 0 },
          { id: uuid(), name: '整份', nameEn: 'Full', priceAdjust: 2000 },
        ],
      },
    ],
  },
  {
    ...
    price: 4500, available: true, sortOrder: 2,
    options: [
      {
        id: uuid(), name: '份量', nameEn: 'Size', required: true,
        choices: [
          { id: uuid(), name: '半份', nameEn: 'Half', priceAdjust: 0 },
          { id: uuid(), name: '整份', nameEn: 'Full', priceAdjust: 2200 },
        ],
      },
    ],
  },
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[1].id, name: '虾滑', nameEn: 'Shrimp Paste', description: '手工虾滑', descriptionEn: 'Handmade shrimp paste', price: 3800, available: true, sortOrder: 3 },
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[2].id, name: '土豆片', nameEn: 'Potato Slices', price: 800, available: true, sortOrder: 1 },
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[2].id, name: '莲藕', nameEn: 'Lotus Root', price: 1000, available: true, sortOrder: 2 },
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[2].id, name: '豆腐', nameEn: 'Tofu', price: 600, available: true, sortOrder: 3 },
  {
    id: uuid(), storeId: store2Id, categoryId: store2Categories[3].id,
    name: '酸梅汤', nameEn: 'Plum Juice', price: 1200, available: true, sortOrder: 1,
    options: [
      {
        id: uuid(), name: '温度', nameEn: 'Temperature', required: true,
        choices: [
  ...
  { id: uuid(), storeId: store2Id, categoryId: store2Categories[3].id, name: '王老吉', nameEn: 'Herbal Tea', price: 800, available: true, sortOrder: 2 },
]
